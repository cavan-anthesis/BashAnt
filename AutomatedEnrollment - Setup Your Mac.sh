...
prefillEmail="false"             # prefills the currently logged in user's email. You need to add to email ending variable
promptForComputerName="false"
prefillComputerName="false"      # prefills the currently logged in user's current computer name
...
brandingBanner="https://euw2.ics.services.jamfcloud.com/icon/hash_cc874d7a3e96f6a621e1b053c374af393944f7f83322c48b1030d8bb9ffd5ef4" # [Image by benzoix on Freepik](https://www.freepik.com/author/benzoix)
brandingBannerDisplayText="true"
brandingIconLight="https://euw2.ics.services.jamfcloud.com/icon/hash_2d58bb2ee45635aab84afecb2887bbdea4ae75efe2932c56cc9d9b970b4d2f9c"
brandingIconDark="https://euw2.ics.services.jamfcloud.com/icon/hash_2d58bb2ee45635aab84afecb2887bbdea4ae75efe2932c56cc9d9b970b4d2f9c"

# [SYM-Helper] IT Support Variables - Use these if the default text is fine but you want your org's info inserted instead
supportTeamName="Anthesis Group IT"
#supportTeamPhone="N/A"
supportTeamEmail="ITTeamAll@anthesisgroup.com"
#supportTeamChat="chat.support.domain.com"
supportTeamChatHyperlink="[${supportTeamChat}](https://${supportTeamChat})"
supportTeamWebsite="anthesisgroup.atlassian.net/servicedesk/customer/portals"
        ...
        * ) # Catch-all )
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Populate User and Location Information",
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_665fe942ce247e868561cf04303b135fee59e2e74fda4d89afb0dac84835442a",
                        "progresstext": "Processing policy: Populate User and Location Information",
                        "trigger_list": [
                                         {
                                            "trigger": "AutomatedEnrolmentUserLocationInformation",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        "listitem": "Rosetta 2 (Skipped for Intel Macs)",
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_cbc32d1aa84b594abee7034b24312dbd05849928ed989ebd1bd8e2c822bb1aed",
                        "progresstext": "Processing policy: Rosetta 2 (Skipped for Intel Macs)",
                        "trigger_list": [
                                         {
                                            "trigger": "EnrolmentRosetta2",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        "listitem": "Escrow Buddy",
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_7111145f93f567623e47e62c4932743d7aa67a6421904c76d7b1d3aae2987d13",
                        "progresstext": "Processing policy: Escrow Buddy",
                        "trigger_list": [
                                         {
                                            "trigger": "EnrolmentEscrowBuddy",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_598ca1043eaa91a6e1876f82de7868248e3b974682a6d3949d8144432091bd1c",
                        "progresstext": "Processing policy: Jamf Connect",
                        "trigger_list": [
                                         {
                                            "trigger": "EnrolmentJamfConnect",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_d9d4a088023762f3595c00716c031cd65a089b3cdbca0a3a840bfad2a20c3b27",
                        "progresstext": "Processing policy: Microsoft Company Portal",
                        "trigger_list": [
                                         {
                                            "trigger": "EnrolmentMicrosoftCompanyPortal",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        "listitem": "Microsoft Defender for Endpoint",
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_d433fefed261a015f6fb9b63a0c909d81e2e298fd12158b07dc097061706ce91",
                        "progresstext": "Processing policy: Microsoft Defender for Endpoint",
                        "trigger_list": [
                                         {
                                            "trigger": "EnrolmentMicrosoftDefenderforEndpoint",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_9df5bc803a0475186be44dc1b0ee48f058172b1e5685df26d722e841175b505d",
                        "progresstext": "Processing policy: Microsoft Office",
                        "trigger_list": [
                                         {
                                            "trigger": "EnrolmentMicrosoftOffice",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_516f086ff9f7f3915067b415e7c8632dd9a750cf60cfda7c43516a2c92663e90",
                        "progresstext": "Processing policy: Microsoft Teams",
                        "trigger_list": [
                                         {
                                            "trigger": "EnrolmentMicrosoftTeams",
                                            "validation": "None"
                                         }
                        ]
                    },
                    {
                        ...
                        "subtitle": "",
                        "icon": "https://euw2.ics.services.jamfcloud.com/icon/hash_5e398086a6efbfde0a631f3ed6c0db6f01ae621f10cf3f6f31a40ed3fc376c73",
